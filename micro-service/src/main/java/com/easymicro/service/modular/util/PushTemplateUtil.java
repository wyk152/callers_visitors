...
public class PushTemplateUtil {
     ...
     * @param
     */
    public static Map approvalResult(String openid,String title,String name,String content){
        Map map = new HashMap();
        JSONObject data = new JSONObject();
        map.put("touser", openid);
        map.put("template_id", "CHebUlLqLFw0gqYpdH8TR9vgKaSkeG5XzQ7Ni4FfA9o");//模板的id
        map.put("url", "");//跳转的路径
     ...
     * @param openid
     */
    public static Map appointment(String openid,String title,String applyContent,String appointmentTime,String applicant,String applyTime){
        Map map = new HashMap();
        JSONObject data = new JSONObject();
        map.put("touser", openid);
        map.put("template_id", "cwGvs5QW7YF5Nqjqx-qH8Y8sueNircjDj_fpyTAyTgA");//模板的id
        map.put("url", "");//跳转的路径
        map.put("topcolor", "#FF0000");
        data.put("first", toJson(title));//标题
     ...
     * @param openid
     */
    public static Map auditingResult(String openid,String title,String result,String auditTime){
        Map map = new HashMap();
        JSONObject data = new JSONObject();
        map.put("touser", openid);
        map.put("template_id", "wCEt3KVSS0coKCx5kpzPVh4b8khpl-V2lG3ycWmQNGQ");//模板的id
        map.put("url", "");//跳转的路径
        map.put("topcolor", "#FF0000");
        data.put("first", toJson(title));//标题

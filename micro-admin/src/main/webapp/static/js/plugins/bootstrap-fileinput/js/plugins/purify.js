;(function(factory) {
   ...
   /**
     ...
     * @protect removeChild
     *
     * @param   saleNode to check for permission to exist
     * @return  true if saleNode was killed, false if left alive
     */
    ...
    var _sanitizeAttributes = function(currentNode) {
        ...
        /* Check if we have attributes; if not we might have a text saleNode */
    ...
    DOMPurify.sanitize = function(dirty, cfg) {
        ...
        /* Check we have a DOM saleNode from the data */
        if (!body) {
            return RETURN_DOM ? null : '';
        }

        /* Get saleNode iterator */

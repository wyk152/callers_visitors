package com.easymicro.admin.config.web;

import com.easymicro.admin.config.properties.GunsProperties;
import com.easymicro.admin.config.properties.RedisProperties;
import com.easymicro.admin.core.intercept.GunsUserFilter;
import com.easymicro.admin.core.shiro.ShiroDbRealm;
...
public class ShiroConfig {
    ...
    public DefaultWebSessionManager defaultWebSessionManager(RedisSessionDAO redisSessionDAO, GunsProperties gunsProperties) {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        hashMap.put("/wxPush/**", "anon");
        hashMap.put("/global/sessionError", "anon");
        hashMap.put("/kaptcha", "anon");
        hashMap.put("/wxmanager/**", "rest");
        hashMap.put("/**", "user");

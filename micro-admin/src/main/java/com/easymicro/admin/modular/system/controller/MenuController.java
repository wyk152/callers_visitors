...
import com.easymicro.admin.core.common.constant.dictmap.MenuDict;
...
import com.easymicro.admin.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public String menuEdit(@PathVariable Long menuId, Model model) {
        ...
        Menu menu = this.menuService.find(menuId);

        //获取父级菜单的id
        Menu temp = new Menu();
        temp.setCode(menu.getPcode());
        Menu pMenu = this.menuService.findOne(Example.of(temp));
    ...
    public Tip edit(@Valid Menu menu, BindingResult result) {
        ...
        //设置父级菜单编号
        menuSetPcode(menu);
        this.menuService.updateSkipNull(menu);
        return SUCCESS_TIP;
    }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            Menu pMenu = menuService.find(code);

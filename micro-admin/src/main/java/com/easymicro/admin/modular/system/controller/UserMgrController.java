...
import com.easymicro.admin.core.common.constant.dictmap.UserDict;
...
import com.easymicro.admin.modular.system.factory.UserFactory;
import com.easymicro.admin.modular.system.transfer.UserDto;
import com.easymicro.admin.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    public Object changePwd(@RequestParam String oldPwd, @RequestParam String newPwd, @RequestParam String rePwd) {
        ...
        if (user.getPassword().equals(oldMd5)) {
            ...
            userService.updateSkipNull(user);
            return SUCCESS_TIP;
        } else {
    ...
    public static void main(String[] args){
        ...
        String oldMd5 = ShiroKit.md5("123456", "8pgby");
    ...
    public Tip edit(@Valid UserDto user, BindingResult result) throws NoPermissionException {
        ...
        if (ShiroKit.hasRole(Const.ADMIN_NAME)) {
            this.userService.updateSkipNull(user1);
            return SUCCESS_TIP;
        } else {
    ...
    public Tip reset(@RequestParam Long userId) {
        ...
        this.userService.updateSkipNull(user);
        return SUCCESS_TIP;
    }
